    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                fireValue=snapshot.child("UltrsonicSensor").getValue(String.class);
               ...
               time_text.setText("Time: "+time);
                ...
                if(value < 20){
                    tv_fire.setText("Anyone move in Garden");
                    gif.setVisibility(View.INVISIBLE);
                }else{
                    tv_fire.setText("No any person in Garden");
                    Glide.with(UltraSensorScreeen.this)
                            .load(R.drawable.door_gif_image)
                            .into(gif);
