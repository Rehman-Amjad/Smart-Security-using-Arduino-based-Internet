    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_smoke_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent backIntent=new Intent(HumidityActivity.this,DashboardScreen.class);
        ...
        myRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                fireValue=snapshot.child("HumiditySensor").getValue(String.class);
                ...
                time_text.setText("Time: "+time);
                    ...
                    tv_fire.setText("Today Humidity is "+ fireValue + "%");
...
//                }
    ...
    public void play()
    {
        if (player == null)
        {
            player = MediaPlayer.create(HumidityActivity.this, R.raw.smokealaem);
